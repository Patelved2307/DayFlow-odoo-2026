...
('COEDELKOLH00104', 'Ravi Sharma', 'ravi.sharma@dayflow.work', '+1 (555) 987-6543', 'Senior Software Engineer', '2023-03-01', '2023-03-10', 'Approved')
ON CONFLICT (interview_id) DO NOTHING;

-- Seed Sample Employees
-- Note: Replace UUIDs with actual auth.users IDs when registering via Supabase Auth.
...
('00000000-0000-0000-0000-000000000002', 'COEDELKOLH00104', 'COEDELKOLH00104', 'Ravi Sharma', 'ravi.sharma@dayflow.work', 'EMPLOYEE', '+1 (555) 987-6543', 'Engineering', 'Senior Software Engineer', 'Tech Lead', '2023-03-15')
...
('COEDELKOLH00104', 7200.00, 22, 5.00, 15.00, 10.00, 10.00, 12.00, 200.00)
ON CONFLICT (employee_id) DO NOTHING;
...
('COEDELKOLH00104', CURRENT_DATE, '09:02:00', '18:05:00', 'Present')
