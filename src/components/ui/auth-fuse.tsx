...
const defaultSignInContent = {
    ...
    quote: {
        text: "Welcome Back! The journey to modern workspace efficiency continues.",
        author: "NexaWork Platform"
    }
};
...
const defaultSignUpContent = {
    image: {
        ...
        alt: "Vibrant collaborative workspace"
    },
    quote: {
        text: "Create an account. Empowering workforce operations with NexaWork.",
        author: "NexaWork HR Suite"
    }
};
