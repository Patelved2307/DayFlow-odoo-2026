  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          'mx-auto flex w-fit items-center gap-3 rounded-2xl bg-white/90 px-3 border border-gray-200/80 shadow-2xl backdrop-blur-xl dark:bg-neutral-900/90 dark:border-neutral-800',
          className
        )}
